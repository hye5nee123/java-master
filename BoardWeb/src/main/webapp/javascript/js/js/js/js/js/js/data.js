let data = `[{"id":1,"first_name":"Delmer","last_name":"Murrthum","email":"dmurrthum0@ovh.net","gender":"Male","salary":5201},
...
export const members = JSON.parse(data);

export const titles = ['id', 'first_name', 'last_name', 'email', 'gender', 'salary']