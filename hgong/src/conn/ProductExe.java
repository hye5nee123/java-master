...
public class ProductExe {
	...
	ProductExe() {
		empList.add(new Product("1", "홍길동", "010-1111-1111", "2022-01-24", 400));
		empList.add(new Product("2", "안영이", "010-2222-2222", "2023-05-10", 300));
		empList.add(new Product("3", "장그래", "010-3333-3333", "2023-10-09", 200));
	}

	// 1. 사원 등록.
	boolean addEmp(String num, String name, String tel, String date, int salary) {
		empList.add(new Product(num, name, tel, date, salary));
		return true;
	}
